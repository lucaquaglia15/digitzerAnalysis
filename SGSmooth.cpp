...
//using float_vect = std::vector<double>; //original, working
using float_vect = std::vector<float>; //new, done by me
 ...
 * used. */
float_vect sg_smooth(const float_vect &v, const int width, const int deg) //original
//vector<double> sg_smooth(const vector<float> &v, const int width, const int deg) //modified by me but working, returns a double
//vector<float> sg_smooth(const vector<float> &v, const int width, const int deg)

{
    float_vect res(v.size(), 0.0);
    //vector<float> res; //added by me
    //res.reserve(v.size()); //added by me
